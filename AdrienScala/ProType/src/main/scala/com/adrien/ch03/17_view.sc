...
/*
palindromicSquares: scala.collection.IndexedSeqView[Int] = IndexedSeqView(<not computed>)
*/

palindromicSquares
/*res0: scala.collection.IndexedSeqView[Int] = IndexedSeqView(<not computed>)*/
...
/*scores: scala.collection.mutable.HashMap[String,Int] = HashMap()*/
